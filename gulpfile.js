...
var path = {
  ...
  'destRootPath': 'htdocs', // 開発用rootディレクトリ
  'destImagePath': 'htdocs/common/img', // 開発用画像格納ディレクトリ
  'destCssPath': 'htdocs/common/css', // 開発用css格納ディレクトリ
  'destJsPath': 'htdocs/common/js', // 開発用js格納ディレクトリ
